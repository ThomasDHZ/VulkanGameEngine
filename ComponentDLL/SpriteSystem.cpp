...
void SpriteSystem_AddSprite(const GraphicsRenderer& renderer, GameObject& gameObject, VkGuid& spriteVramId)
{
    Sprite sprite;
...
void SpriteSystem_Update(const GraphicsRenderer& renderer, const float& deltaTime)
{
