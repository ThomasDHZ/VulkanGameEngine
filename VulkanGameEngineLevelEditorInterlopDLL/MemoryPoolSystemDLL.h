...
extern "C" {
	...
	DLL_EXPORT DirectionalLightComponent*	 MemoryPoolSystem_UpdateDirectionalLight(uint32 index);
	DLL_EXPORT PointLightComponent*			 MemoryPoolSystem_UpdatePointLight(uint32 index);
