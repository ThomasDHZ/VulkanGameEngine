...
namespace VulkanEngineCS
{
    ...
    public static unsafe class MemoryPoolSystem
    {
        ...
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern void MemoryPoolSystem_StartUp();
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern uint MemoryPoolSystem_AllocateObject(MemoryPoolTypes memoryPoolToUpdate);
        ...
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern MeshPropertiesStruct* MemoryPoolSystem_UpdateMesh(uint index);
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern GPUMaterial* MemoryPoolSystem_UpdateMaterial(uint index);
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern DirectionalLight* MemoryPoolSystem_UpdateDirectionalLight(uint index);
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern PointLight* MemoryPoolSystem_UpdatePointLight(uint index);
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern SceneDataBuffer* MemoryPoolSystem_UpdateSceneDataBuffer();
        [DllImport("VulkanEngineInterop.dll", CallingConvention = CallingConvention.StdCall)] private static extern void MemoryPoolSystem_FreeObject(MemoryPoolTypes memoryPoolToUpdate, uint index);
    }
}
