...
layout(constant_id = 17) const uint DescriptorBindingType3 = 3;
...
void main() 
{
    ...
    gl_Position = directionalLightPushConstant.LightProjection * 
                  directionalLightPushConstant.LightView *  
