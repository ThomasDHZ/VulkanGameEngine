...
layout(constant_id = 23)  const uint DescriptorBindingType9   = SubpassInputDescriptor;
layout(constant_id = 24)  const uint DescriptorBindingType10  = MeshPropertiesDescriptor;
layout(constant_id = 25)  const uint DescriptorBindingType11  = MaterialDescriptor;
layout(constant_id = 26)  const uint DescriptorBindingType12  = DirectionalLightDescriptor;
layout(constant_id = 27)  const uint DescriptorBindingType13  = PointLightDescriptor;
layout(constant_id = 28)  const uint DescriptorBindingType14  = TextureDescriptor;
layout(constant_id = 29)  const uint DescriptorBindingType15  = SkyBoxDescriptor;
layout(constant_id = 30)  const uint DescriptorBindingType16  = IrradianceCubeMapDescriptor;
layout(constant_id = 31)  const uint DescriptorBindingType17  = PrefilterDescriptor;
