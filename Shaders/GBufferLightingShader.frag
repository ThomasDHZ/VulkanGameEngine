...
layout(binding = 9)  buffer MaterialProperities { MaterialProperitiesBuffer2 materialProperties; } materialBuffer[];
...
//    vec3  color = ambient + Lo;
 outColor = vec4(packedMRO.r, packedMRO.g, packedMRO.b, 1.0);
