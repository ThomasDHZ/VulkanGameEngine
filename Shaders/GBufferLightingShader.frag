...
layout(input_attachment_index = 1, binding = 1) uniform subpassInput albedoInput;         //Albedo/Alpha                                                                               - R8G8B8A8_SRGB
...
layout(input_attachment_index = 7, binding = 7) uniform subpassInput emissionInput;       //Emission                                                                                   - R8G8B8A8_SRGB
