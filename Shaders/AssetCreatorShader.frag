...
void main()
{
    ...
    outAlbedo = albedo;
    outNormalData = vec4(0.5, 0.5, 1.0, 1.0); // Visible blue-ish
    outPackedMRO = vec4(1.0, 0.0, 1.0, 1.0); // Magenta
    outPackedSheenSSS = vec4(0.0, 1.0, 1.0, 1.0); // Cyan
    outEmission = vec4(1.0, 1.0, 0.0, 1.0); // Yellow
