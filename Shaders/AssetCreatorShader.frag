...
layout(binding = 0)  buffer  MaterialProperities { ImportMaterial importMaterialProperties; } importMaterialBuffer;
...
void main()
{
    ...
    vec3  emission                  = (material.EmissionMap                  != 0xFFFFFFFFu) ? textureLod(EmissionMap,                  UV, 0.0f).rgb               : vec3(1.0f);
