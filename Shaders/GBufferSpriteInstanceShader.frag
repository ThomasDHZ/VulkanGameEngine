...
void main() 
{
    ...
    vec2 finalUV = ParallaxOcclusionMapping(UV, viewDirTS, material.NormalTextureId);
    ...
    vec2 f = normalDataMap.xy * 2.0f - 1.0f;
    float normalStrength = normalDataMap.b;
    ...
    float selfShadow = HeightSelfShadow(finalUV, Lts, material.NormalTextureId, heightRaw, minUV, maxUV);
