...
#include "basisu_comp.h"          // basis_compressor & basis_compressor_params
#include "basisu_gpu_texture.h"   // basisu::image
#include "basisu_enc.h"           // often needed

#include <ktx.h>
#include <ktxvulkan.h>

#include <vector>  // if basisu::vector doesn't suffice



//void TextureBakerSystem::BakeTexture(const String& textureName, ImportTexture& importTexture)
//{
...
RawMipReadback TextureBakerSystem::ConvertToRawTextureData(ImportTexture& importTexture, uint32 mipLevel)
{
