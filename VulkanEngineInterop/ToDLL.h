...
extern "C" {
#endif
    DLL_EXPORT RenderPassNodeDLL* ToDLL_RenderPassNodeDLL(Vector<RenderPassNode>& renderPassNodeList, VkCommandBuffer& commandBuffer, float deltaTime, size_t* renderPassNodeCount);
#ifdef __cplusplus
}
#endif
