...
VkGuid MaterialSystem::LoadMaterial(const nlohmann::json& json)
{
    ...
    material.SheenRoughness                 = json.value("SheenRoughness", 0.5f);
    material.SSSWeight                      = json.value("SSSWeight", 0.0f);
    material.SSSProfile                     = json.value("SSSProfile", 0.0f);
    ...
    gpuMaterial.SheenRoughness                 = material.SheenRoughness;
    gpuMaterial.SSSWeight                      = material.SSSWeight;
    gpuMaterial.SSSProfile                     = material.SSSProfile;
