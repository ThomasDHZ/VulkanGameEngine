...
public:
    ...
    DLL_EXPORT VkResult                      EndSingleUseCommand(VkCommandBuffer commandBuffer);
    DLL_EXPORT VkResult                      EndSingleUseCommand(VkCommandBuffer commandBuffer, VkCommandPool& commandPool);
