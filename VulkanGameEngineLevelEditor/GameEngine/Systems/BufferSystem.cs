...
namespace VulkanGameEngineLevelEditor.GameEngine.Systems
{
    public static unsafe class BufferSystem
    {
        ...
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern VulkanBuffer VulkanBuffer_CreateVulkanBuffer(GraphicsRenderer renderer, uint bufferId, VkDeviceSize bufferElementSize, uint bufferElementCount, BufferTypeEnum bufferTypeEnum, VkBufferUsageFlagBits usage, VkMemoryPropertyFlagBits properties, bool usingStagingBuffer);
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern VulkanBuffer VulkanBuffer_CreateVulkanBuffer2(GraphicsRenderer renderer, uint bufferId, void* bufferData, VkDeviceSize bufferElementSize, uint bufferElementCount, BufferTypeEnum bufferTypeEnum, VkBufferUsageFlagBits usage, VkMemoryPropertyFlagBits properties, bool usingStagingBuffer);
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern VulkanBuffer VulkanBuffer_CreateVulkanBuffer3(GraphicsRenderer renderer, VulkanBuffer vulkanBuffer, uint bufferId, void* bufferData, VkDeviceSize bufferElementSize, uint bufferElementCount, BufferTypeEnum bufferTypeEnum, VkBufferUsageFlagBits usage, VkMemoryPropertyFlagBits properties, bool usingStagingBuffer);
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern void VulkanBuffer_UpdateBufferMemory(GraphicsRenderer renderer, VulkanBuffer vulkanBuffer, void* bufferData, VkDeviceSize bufferElementSize, uint bufferElementCount);
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern VkResult VulkanBuffer_CopyBuffer(GraphicsRenderer renderer, VkBuffer* srcBuffer, VkBuffer* dstBuffer, VkDeviceSize size);
        [DllImport(DLLSystem.DLLPath, CallingConvention = CallingConvention.StdCall)] public static extern void VulkanBuffer_DestroyBuffer(GraphicsRenderer renderer, VulkanBuffer vulkanBuffer);
    }
}
