 ...
 public static class DLLSystem
    {
        ...
        public const string MaterialBakerDLL = @"C:\Users\DHZ\Documents\GitHub\VulkanGameEngine\x64\Debug\VulkanGameEngineLevelEditorInterlopDLL.dll";
        ...
        public static void SetSharedDllDirectory()
        {
            ...
            string dllDir = Path.GetDirectoryName(MaterialBakerDLL)!;
            if (!Directory.Exists(dllDir))
            {
                throw new DirectoryNotFoundException($"DLL folder missing: {dllDir}");
            }

            IntPtr gameEngineDLLPtr = LoadLibrary(MaterialBakerDLL);
